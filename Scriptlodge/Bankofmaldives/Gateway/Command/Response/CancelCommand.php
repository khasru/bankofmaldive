 ...
 */
namespace Scriptlodge\Bankofmaldives\Gateway\Command\Response;
...
class CancelCommand implements CommandInterface
{
    ...
    public function execute(array $commandSubject)
    {
       ...
       // $this->orderManagementInterface->add($response['ReasonCodeDesc']);

        $payment->setAdditionalInformation('response', $response)->save();
